    ...
    public class ApplicantProfileLogic : BaseLogic<ApplicantProfilePoco>
    {
        ...
        protected override void Verify(ApplicantProfilePoco[] pocos)
        {
            ...
            foreach (var poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(111, $"CurrentSalary for ApplicationProfile {poco.Id}  cannot be negative"));
                }
                if(poco.CurrentRate < 0)
                {
                    exceptions.Add(new ValidationException(112, $"CurrentRate for ApplicationProfile {poco.Id}  CurrentRate cannot be negative "));
